...
male_cells <- readRDS("male_CD8T_cells_191124.rds")
...
male_cells$new_classification[male_cells$seurat_clusters %in% c("0")] <- "CD8et"
...
saveRDS(male_cells, file = "male_CD8T_cells_191124_2.rds")
...
ggsave(filename = "UMAP_Clustering_Male_CD8T_Cells_newclassification.png", plot = umap_plot,
...
write.csv(dge_results, file = "DGE_results_CD8nc_in_LOY_with_gene_names.csv", row.names = FALSE)
...
ggsave("volcano_plot_CD8nc_LOY.png", volcano_plot, width = 8, height = 6)
###################################################
# Ensure 'B-in' cells are the focus
Idents(object= male_cells) <- "new_classification"  # Set cluster classification as identity
...
# Save the results to a CSV file
write.csv(dge_results, file = "DGE_results_CD8et_mem_LOY_with_gene_names.csv", row.names = FALSE)
...
# Save the volcano plot
ggsave("volcano_plot_CD8et_LOY.png", volcano_plot, width = 8, height = 6)
