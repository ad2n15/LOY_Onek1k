...
male_cells <- readRDS("female_mono_cells_191124.rds")
...
male_cells$new_classification[male_cells$seurat_clusters %in% c("0", "1")] <- "mono-c"
male_cells$new_classification[male_cells$seurat_clusters %in% c("2", "3", "6")] <- "mono-nc"
...
saveRDS(male_cells, file = "female_mono_cells_191124_2.rds")
...
ggsave(filename = "UMAP_Clustering_FeMale_mono_Cells_newclassification.png", plot = umap_plot,
...
write.csv(dge_results, file = "DGE_results_mono_c_LOY_with_gene_names_female.csv", row.names = FALSE)
...
ggsave("volcano_plot_mono_c_LOY_female.png", volcano_plot, width = 8, height = 6)
###################################################
# Ensure 'B-in' cells are the focus
Idents(object= male_cells) <- "new_classification"  # Set cluster classification as identity
...
# Save the results to a CSV file
write.csv(dge_results, file = "DGE_results_mono_nc_LOY_with_gene_names_female.csv", row.names = FALSE)
...
# Save the volcano plot
ggsave("volcano_plot_mono_nc_LOY_female.png", volcano_plot, width = 8, height = 6)
