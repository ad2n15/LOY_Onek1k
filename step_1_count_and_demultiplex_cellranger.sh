...
sbatch --wait --job-name=cellranger_$1 --output=cellranger_$1.log scripts_for_count_and_demultiplex_cellranger_step/run_cellranger.sh $1

sbatch --wait --job-name=demuliplex_$1 --output=demuliplex_$1.log scripts_for_count_and_demultiplex_cellranger_step/demuliplex_bam_file.sh $1

sbatch --wait --job-name=subset_$1 --output=subset_$1.log scripts_for_count_and_demultiplex_cellranger_step/subset_expression_by_indv.sh $1
