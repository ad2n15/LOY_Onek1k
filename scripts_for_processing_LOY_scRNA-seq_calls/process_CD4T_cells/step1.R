...
ggsave(filename = "UMAP_Clustering_Male_CD4T_Cells_original.png", plot = umap_plot,
...
saveRDS(male_cells, file = "male_CD4T_cells_191124.rds")
...
umap_plot <- DimPlot(male_cells, reduction = "umap", group.by = "seurat_clusters", label=TRUE, repel = TRUE) +
  ggtitle("UMAP Clustering of Male Cells")
ggsave(filename = "UMAP_Clustering_Male_CD4T_Cells_instructions_label.png", plot = umap_plot,
       width = 8, height = 6, dpi = 300)
...
umap_plot <- DimPlot(male_cells, reduction = "umap", group.by = "predicted.celltype.l2", label=TRUE) +
  ggtitle("UMAP Clustering of Male Cells")
ggsave(filename = "UMAP_Clustering_Male_CD4T_Cells_azimuth_instructions_label.png", plot = umap_plot,
       width = 8, height = 6, dpi = 300)
...
write.csv(filtered_markers, "filtered_markers_CD4T_cells_clusters_191124.csv", row.names = FALSE)
