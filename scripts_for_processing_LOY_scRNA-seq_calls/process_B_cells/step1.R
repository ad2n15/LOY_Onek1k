...
ggsave(filename = "UMAP_Clustering_Male_B_Cells_original.png", plot = umap_plot,
...
saveRDS(male_cells, file = "male_B_cells_191124.rds")
...
umap_plot <- DimPlot(male_cells, reduction = "umap", group.by = "seurat_clusters") +
  ggtitle("UMAP Clustering of Male Cells")
ggsave(filename = "UMAP_Clustering_Male_B_Cells_instructions.png", plot = umap_plot,
       width = 8, height = 6, dpi = 300)
...
umap_plot <- DimPlot(male_cells, reduction = "umap", group.by = "predicted.celltype.l2") +
  ggtitle("UMAP Clustering of Male Cells")
ggsave(filename = "UMAP_Clustering_Male_B_Cells_azimuth_instructions.png", plot = umap_plot,
       width = 8, height = 6, dpi = 300)
...
write.csv(filtered_markers, "filtered_markers_B_cells_clusters_191124.csv", row.names = FALSE)
